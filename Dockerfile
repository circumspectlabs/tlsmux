...
FROM nginx:${NGINX_VERSION}-alpine${ALPINE_VERSION}-slim AS base
...
# Get modules
ARG MODULE_VTS_VERSION=0.2.7
ARG MODULE_MORE_VERSION=0.40
ARG MODULE_NDK_VERSION=0.3.4
ARG MODULE_LUA_VERSION=0.10.31
ARG MODULE_LUA_STREAM_VERSION=0.0.17R4
ARG MODULE_LUA_UPSTREAM_VERSION=0.08
ARG MODULE_RATELIMIT_VERSION=1.0.0
ARG MODULE_REPLACE_FILTER_VERSION=0.01rc5
ARG MODULE_ECHO_VERSION=0.65
